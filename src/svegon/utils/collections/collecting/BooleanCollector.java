package svegon.utils.collections.collecting;

import com.google.common.base.Preconditions;
import svegon.utils.collections.ImmutableEnumSet;
...
public interface BooleanCollector<A, R> {
     ...
     */
    ObjectBooleanConsumer<A> accumulator();
    ...
    static <A, R> BooleanCollector<A, R> of(Supplier<A> supplier, ObjectBooleanConsumer<A> accumulator,
    ...
    final class BooleanCollectorImpl<A, R> implements BooleanCollector<A, R> {
        ...
        private final ObjectBooleanConsumer<A> accumulator;
        private final BinaryOperator<A> combiner;
        private final Function<A, R> finisher;
        private final ImmutableEnumSet<Collector.Characteristics> characteristics;

        private BooleanCollectorImpl(Supplier<A> supplier, ObjectBooleanConsumer<A> accumulator,
                                     BinaryOperator<A> combiner, Function<A, R> finisher,
                                     ImmutableEnumSet<Collector.Characteristics> characteristics) {
        ...
        @Override
        public ObjectBooleanConsumer<A> accumulator() {
            return accumulator;
        }
