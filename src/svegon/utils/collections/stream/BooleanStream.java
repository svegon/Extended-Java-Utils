...
import svegon.utils.fast.util.booleans.BooleanSummaryStatistics;
...
import svegon.utils.fuck_modifiers.Streams;
...
public interface BooleanStream extends BaseStream<Boolean, BooleanStream> {
     ...
     * production of some or all the elements (such as with boolean-circuiting
     ...
     *
     * <p>This is a <a href="package-summary.html#StreamOps">boolean-circuiting
     ...
     */
    <R> R collect(Supplier<R> supplier, ObjectBooleanConsumer<R> accumulator, BiConsumer<R, R> combiner);
     ...
     * {@link #collect(Supplier, ObjectBooleanConsumer, BiConsumer)}, allowing for reuse of
     ...
     * @return the result of the reduction
     * @see #collect(Supplier, ObjectBooleanConsumer, BiConsumer)
     * @see Collectors
     */
    ...
    /**
     * Returns a {@code BooleanSummaryStatistics} describing various summary data
     ...
     * operation</a>.
     *
     * @return a {@code BooleanSummaryStatistics} describing various summary data
