...
public final class Streams {
    ...
    public static final class StreamBuilderImpl<T>
        ...
        // non-null if count == 2
        svegon.utils.fuck_modifiers.SpinedBuffer<T> buffer;
        ...
        public void accept(T t) {
            if (count == 0) {
                ...
                if (buffer == null) {
                    buffer = new svegon.utils.fuck_modifiers.SpinedBuffer<>();
                    buffer.accept(first);
                    count++;
                }
    ...
    public static final class IntStreamBuilderImpl extends AbstractStreamBuilderImpl<Integer, Spliterator.OfInt>
        ...
        // The first and subsequent elements in the stream
        // non-null if count == 2
        svegon.utils.fuck_modifiers.SpinedBuffer.OfInt buffer;
        ...
        public void accept(int t) {
            if (count == 0) {
                ...
                if (buffer == null) {
                    buffer = new svegon.utils.fuck_modifiers.SpinedBuffer.OfInt();
                    buffer.accept(first);
                    count++;
                }
    ...
    static final class LongStreamBuilderImpl
        ...
        // The first and subsequent elements in the stream
        // non-null if count == 2
        svegon.utils.fuck_modifiers.SpinedBuffer.OfLong buffer;
        ...
        public void accept(long t) {
            if (count == 0) {
                ...
                if (buffer == null) {
                    buffer = new svegon.utils.fuck_modifiers.SpinedBuffer.OfLong();
                    buffer.accept(first);
                    count++;
                }
    ...
    public static final class DoubleStreamBuilderImpl
        ...
        // The first and subsequent elements in the stream
        // non-null if count == 2
        svegon.utils.fuck_modifiers.SpinedBuffer.OfDouble buffer;
        ...
        public void accept(double t) {
            if (count == 0) {
                ...
                if (buffer == null) {
                    buffer = new svegon.utils.fuck_modifiers.SpinedBuffer.OfDouble();
                    buffer.accept(first);
                    count++;
                }
