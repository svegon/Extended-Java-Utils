...
public final class Nodes {
    ...
    /**
     * Produces a {@link Node.OfBoolean} describing a double[] array.
     *
     * <p>The node will hold a reference to the array and will not make a copy.
     *
     * @param array the array
    ...
    /**
     * Produces a {@link Node.OfByte} describing a double[] array.
     *
     * <p>The node will hold a reference to the array and will not make a copy.
     *
     * @param array the array
    ...
    /**
     * Produces a {@link Node.OfShort} describing a double[] array.
     *
     * <p>The node will hold a reference to the array and will not make a copy.
     *
     * @param array the array
    ...
    /**
     * Produces a {@link Node.OfChar} describing a double[] array.
     *
     * <p>The node will hold a reference to the array and will not make a copy.
     *
     * @param array the array
    ...
    /**
     * Produces a {@link Node.OfFloat} describing a double[] array.
     *
     * <p>The node will hold a reference to the array and will not make a copy.
     *
     * @param array the array
    ...
    /**
     * Collect, in parallel, elements output from a boolean-valued pipeline and
    ...
    static final class ConcNode<T>
        ...
        public static final class OfBoolean extends OfPrimitive<Boolean, BooleanConsumer, boolean[],
            ...
            OfBoolean(OfBoolean left, OfBoolean right) {
                super(left, right);
            }
        ...
        public static final class OfByte extends OfPrimitive<Byte, ByteConsumer, byte[],
            ...
            OfByte(OfByte left, OfByte right) {
                super(left, right);
            }
        ...
        public static final class OfShort extends OfPrimitive<Short, ShortConsumer, short[],
            ...
            OfShort(OfShort left, OfShort right) {
                super(left, right);
            }
        ...
        public static final class OfChar extends OfPrimitive<Character, CharConsumer, char[],
            ...
            OfChar(OfChar left, OfChar right) {
                super(left, right);
            }
        ...
        public static final class OfFloat extends OfPrimitive<Float, FloatConsumer, float[],
            ...
            OfFloat(OfFloat left, OfFloat right) {
                super(left, right);
            }
    ...
    private static class CollectorTask<P_IN, P_OUT, T_NODE extends Node<P_OUT>, T_BUILDER extends Node.Builder<P_OUT>>
        ...
        @SuppressWarnings("serial")
        private static final class OfBoolean<P_IN> extends CollectorTask<P_IN, Boolean, Node.OfBoolean,
                Node.Builder.OfBoolean> {
            OfBoolean(PipelineHelper<Boolean> helper, Spliterator<P_IN> spliterator) {
                super(helper, spliterator, Nodes::booleanBuilder, ConcNode.OfBoolean::new);
            }
        }

        @SuppressWarnings("serial")
        private static final class OfByte<P_IN> extends CollectorTask<P_IN, Byte, Node.OfByte, Node.Builder.OfByte> {
            OfByte(PipelineHelper<Byte> helper, Spliterator<P_IN> spliterator) {
                super(helper, spliterator, Nodes::byteBuilder, ConcNode.OfByte::new);
            }
        }

        @SuppressWarnings("serial")
        private static final class OfShort<P_IN> extends CollectorTask<P_IN, Short, Node.OfShort,
                Node.Builder.OfShort> {
            OfShort(PipelineHelper<Short> helper, Spliterator<P_IN> spliterator) {
